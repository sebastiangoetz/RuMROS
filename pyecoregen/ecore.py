...
class EcoreHTMLTask(EcoreTask):
    """Generation of HTML-Code from Ecore model with Jinja2."""

    template_name = 'index.html.tpl'
    element_type = ecore.EPackage
    ...
    @staticmethod
    def filename_for_element(package: ecore.EPackage):
        return '{}.html'.format(package.name)
...
class EcoreGenerator(multigen.jinja.JinjaGenerator):
    ...
    def __init__(self, *, user_module=None, auto_register_package=False,
        ...
        ## EcoreHTMLTask added --> removed formatter to get correct HTML-Code
        self.tasks = [
